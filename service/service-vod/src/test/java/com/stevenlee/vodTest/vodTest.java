...
//文件名必须包含扩展名
        String fileName = "D:\\资料\\项目资料\\1-阿里云上传测试视频\\6 - What If I Want to Move Faster.mp4";
//本地文件上传
        UploadVideoRequest request = new UploadVideoRequest("LTAI5t8U2ounh9LbdPUCk2zZ",
                "Ma5QVh0p0dp4p6cFkKCHVvySf52N5k", title, fileName);
